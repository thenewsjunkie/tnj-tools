...
const MusicManager = () => {
  ...
  const copyEmbedCode = (id: string) => {
    const code = `<iframe src="https://tnjtools.com/music-embed/${id}" width="100%" height="340" style="border:0;border-radius:8px;" allowfullscreen></iframe>`;
    ...
    <div className="space-y-4">
      ...
      {songs.length > 0 && (
        <Button
          ...
          className="w-full"
          onClick={() => {
            const code = `<iframe src="https://tnjtools.com/music-embed" width="100%" height="340" style="border:0;border-radius:8px;" allowfullscreen></iframe>`;
            navigator.clipboard.writeText(code);

                  ...
                  <Button
                    ...
                    onClick={() => {
                      if (customName.trim()) {
                        ...
                        setIsEditing(false);
                        toast({
                          title: "Custom contestant saved",
                          description: `${customName.trim()} has been added to the contestants list`,
                        });
                      }
                    }}

  ...
  return (
    <div
      className={cn(
        ...
        isPinned
          ? "bg-yellow-500/10 border border-yellow-500/30 dark:bg-yellow-500/20 dark:border-yellow-500/50"
          : message.message_type === "superchat"
          ? "bg-green-500/10 border border-green-500/30 dark:bg-green-500/20 dark:border-green-500/50"
          : ""
      )}
    >
      {renderIcon()}

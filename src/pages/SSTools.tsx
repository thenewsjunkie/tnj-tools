...
const EMBED_CODE = `<iframe src="${window.location.origin}/sstools" width="100%" height="200" frameborder="0" style="border:none;overflow:hidden;" allowtransparency="true"></iframe>`;

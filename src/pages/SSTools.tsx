...
const EMBED_CODE = `<iframe src="${window.location.origin}/sstools/embed" width="100%" height="80" frameborder="0" style="border:none;overflow:hidden;display:block;" allowtransparency="true"></iframe>`;
